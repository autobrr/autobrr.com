...
title: "Sizechecker: stop downloads when disk is full"
description: Sizechecker is an autobrr companion that rejects new downloads when used or free disk space crosses a limit, with Discord and webhook notifications.
