...
title: "Upgraderr: upgrade, deduplicate and cross-seed"
description: Upgraderr parses release titles to upgrade existing downloads, remove duplicates and cross-seed, with no configuration required.
