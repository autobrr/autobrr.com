...
title: Manage torrents automatically alongside autobrr
description: Third-party tools that manage torrents in your client by seed time, ratio and tracker rules, and how they fit together with autobrr.
