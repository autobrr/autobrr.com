---
title: Category examples by tracker
description: Tracker category names to use in autobrr filters, contributed by users, with instructions for exporting categories from autobrr.db.
