---
title: Macros for actions and external filters
description: "Macros inject release data into actions and external filters using variables like {{ .TorrentName }}, {{ .Indexer }} and {{ .Resolution }}."
