...
description: "How autobrr's Skip Duplicates feature and duplicate profiles work: which release attributes are compared and how to stop grabbing the same content twice."
