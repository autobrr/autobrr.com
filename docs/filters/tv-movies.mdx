...
title: TV and movie filters
description: "TV and movie filter fields in autobrr: seasons, episodes, years, resolutions, sources, codecs, containers, HDR and wildcard matching."
