...
title: General filter settings
description: "Every field on the General tab of an autobrr filter: name, indexers, announce type, priority, delay, max downloads and skip duplicates profile."
