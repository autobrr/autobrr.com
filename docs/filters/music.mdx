...
sidebar_label: Music
title: Music filters
description: "Music filter fields in autobrr: artists, albums, format, quality, media, log score, cue, perfect FLAC, record labels and release type."
...
| **Perfect FLAC** | Overrides all options about quality, source, format, and Cue/Log/Log score. Requires: any media, FLAC, Lossless or 24bit Lossless; if the media is CD, also requires Log with a 100% score.                                                                           |
