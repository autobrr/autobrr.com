...
title: autobrr REST API reference
description: "Reference for the autobrr REST API: authenticating with API keys, the endpoint documentation and examples for integrating autobrr with your own tools."
...
Scheduled cleanups can be managed in the UI or via the `/release/cleanup-jobs` endpoints, see [Release history cleanup](./usage/search.mdx#release-history-cleanup).
