---
id: caddy
title: Caddy reverse proxy for autobrr
description: Caddyfile examples for running autobrr behind Caddy on a subdomain or a subfolder, including the matching base URL setting.
