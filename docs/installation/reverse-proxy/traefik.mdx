---
id: traefik
title: Traefik reverse proxy for autobrr
description: Docker Compose labels for running autobrr behind Traefik on a subdomain, with an external proxy network and http and https entry points.
