---
id: lighttpd
title: lighttpd reverse proxy for autobrr
description: lighttpd mod_proxy example for running autobrr behind lighttpd on a subfolder, including the matching base URL setting.
