---
id: swag
title: SWAG reverse proxy for autobrr
description: SWAG (LinuxServer nginx) configuration for autobrr on a subdomain, with optional LDAP, Authelia or Authentik authentication.
