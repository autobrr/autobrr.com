---
id: nginx
title: Nginx reverse proxy for autobrr
description: Nginx location and server block examples for running autobrr behind Nginx on a subfolder or subdomain, with forwarded headers and basic auth.
