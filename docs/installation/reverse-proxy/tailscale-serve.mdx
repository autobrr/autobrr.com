---
id: tailscale-serve
title: Tailscale Serve as a reverse proxy for autobrr
description: Expose autobrr over your tailnet with Tailscale Serve, which gives you HTTPS and a stable hostname without opening ports or running a separate proxy.
