...
description: "Run autobrr on PostgreSQL instead of the bundled SQLite: when it makes sense, the config.toml settings and how to migrate an existing database."
