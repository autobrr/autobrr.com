...
title: Install autobrr on a shared or dedicated seedbox
description: Install autobrr on a dedicated server or a shared, non-root seedbox from Ultra.cc, Whatbox, Seedhost, HostingBy.Design, Feral, Bytesized, Giga-Rapid or RapidSeedbox.
keywords:
  [
    autobrr,
    installation,
...
Note: Remember to head over to our [Configuration Guide](../configuration/indexers.mdx) to learn how to set up your indexers, IRC, and [download clients](../configuration/download-clients/shared.mdx) after you're done installing.
