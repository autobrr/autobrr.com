...
description: Confirmed connection settings for download clients on shared seedbox providers, so autobrr can reach qBittorrent, Deluge, rTorrent and Transmission.
