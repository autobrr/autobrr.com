...
title: Configure autobrr with config.toml
description: "Every setting in autobrr's config.toml explained: host, port, base URL, log level, database, session, OIDC and update checks, with defaults and examples."
