...
sidebar_position: 1
description: "How authentication works in autobrr: the built-in username and password login and OpenID Connect (OIDC) single sign-on, and how to configure each."
---
