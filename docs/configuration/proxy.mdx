...
title: Proxies for indexers and IRC
description: "Route autobrr's torrent downloads, indexer API calls, feeds and IRC connections through a SOCKS5 or HTTP proxy, per indexer or per network."
keywords:
  [
    autobrr,
    setup,
