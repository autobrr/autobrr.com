...
title: Notifications for pushes and errors
description: Send autobrr notifications to Discord, Notifiarr, Telegram, Pushover, Gotify, ntfy, LunaSea, Shoutrrr or a webhook on push, error and IRC events.
keywords:
  [
    autobrr,
    setup,
