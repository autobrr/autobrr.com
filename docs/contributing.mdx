...
description: "How to contribute to autobrr: discuss larger changes first, set up the Go and React development environment, run the tests and open a pull request."
keywords:
